...
| T7 managed compose stack + operator docs | 🟡 Partial | `deploy/compose/managed.yml` exists (0006-G); still needs a **seed script** for a demo tenant, `docs/operator-runbook.md` (missing), and verification the stack runs the DoD journey end-to-end. |
