...
import type { CalendarEvent, CalendarFolder, RawCalendarEvent } from './calendar';
import type { Contact, ContactFolder, RawContact } from './contact';
import type { FileItem, FileFolder, RawFileItem } from './file';
